...
org-seq 设计为与 Obsidian 共存：

1. **Obsidian vault** 指向 `~/NoteHQ/`
2. **Emacs** 用于深度编辑、GTD 管理、AI 辅助
3. **Obsidian** 用于快速浏览、移动端访问、图谱探索

md-roam 使 org-roam 能索引 `.md` 文件，两边的链接图谱共享。
