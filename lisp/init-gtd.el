...
;;
;; A complete GTD workflow on top of org-mode's agenda system: agenda file
;; cache, a state machine, context views, and visual polish. Everything
;; happens inside org buffers and uses org-mode's native task state
;; transitions -- this module only adds higher-level ergonomics.
;; The live-count *GTD* dashboard buffer and its auto-refresh machinery
;; live in init-gtd-dashboard.el.
;;
;; ┌─────────────────────────────────────────────────────────────────┐
;; │                       Table of Contents                          │
;; ├─────────────────────────────────────────────────────────────────┤
...
;; │                                                                  │
;; │ Section 10  GTD-specific org config (hooks + agenda commands)    │
